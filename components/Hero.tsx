  ...
  return (
    <section className="relative px-4 sm:px-6 lg:px-8 pt-24 pb-16 transition-colors duration-300 overflow-visible">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-visible">
        ...
        <div className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-accent-dark rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-20 animate-pulse delay-150"></div>
      </div>
