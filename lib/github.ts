...
const developerProjects: GitHubRepo[] = [
  ...
  },
  {
    ...
    full_name: 'd4vid4nderson/teams-calendar-webpart',
    description: "The modern SharePoint calendar webpart has zero connection to Teams or Outlook — it's a standalone calendar requiring constant manual updates. This SPFx webpart fixes that by connecting SharePoint pages directly to Teams group calendars via Graph API. Month, week, and list calendar views plus an events card view with attendee RSVP, meeting details, and one-click join for Teams, Zoom, and Google Meet.",
    html_url: '#',
    homepage: null,
    stargazers_count: 0,
    forks_count: 0,
    fork: false,
    language: 'TypeScript',
    topics: ['typescript', 'react', 'spfx', 'azure', 'microsoft-graph'],
    techStackCount: 7,
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    pushed_at: new Date().toISOString(),
